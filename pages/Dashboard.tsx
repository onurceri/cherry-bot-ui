    ...
    <div className="space-y-8">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          {bots.map((bot) => (
            <Card key={bot.id} className="group hover:shadow-md transition-all duration-200 border-slate-200 flex flex-col h-full">
              ...
              <CardFooter className="pt-0 mt-auto flex flex-col items-stretch gap-2">
        ...
        <div className="text-center py-20 bg-white rounded-xl border border-dashed border-slate-300">
          ...
          <Link to="/bot/new" className="mt-4 inline-block">
